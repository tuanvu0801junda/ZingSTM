...
CREATE TABLE `genre` (
  ...
  `genreImage` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `listenhistory`
--

CREATE TABLE `listenhistory` (
  `songId` bigint(20) UNSIGNED NOT NULL,
  `listenDate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `playlist` (
  `playlistId` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `playlistcomment` (
  `userId` bigint(20) UNSIGNED NOT NULL,
  `playlistId` bigint(20) UNSIGNED NOT NULL,
  `userComment` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdDate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `playlistCommentId` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `playlistsongrelation`
--
...
--
-- Table structure for table `shareplaylist`
--

CREATE TABLE `shareplaylist` (
  `userId` bigint(20) UNSIGNED NOT NULL,
  `playlistId` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `song` (
  ...
  `songPath` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `playTimes` bigint(20) NOT NULL DEFAULT 0,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `songartistrelation`
--
...
--
-- Dumping data for table `songartistrelation`
--
...
CREATE TABLE `songcomment` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `songCommentId` bigint(20) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `songgenrerelation`
--
...
--
-- Dumping data for table `songgenrerelation`
--
...
--
-- Indexes for table `listenhistory`
--
ALTER TABLE `listenhistory`
  ADD KEY `listenhistory_songid_foreign` (`songId`);
...
ALTER TABLE `playlist`
  ...
  ADD KEY `playlist_userid_foreign` (`userId`);

--
-- Indexes for table `playlistcomment`
--
ALTER TABLE `playlistcomment`
  ADD PRIMARY KEY (`playlistCommentId`),
  ADD KEY `playlistcomment_userid_foreign` (`userId`),
  ADD KEY `playlistcomment_playlistid_foreign` (`playlistId`);

--
-- Indexes for table `playlistsongrelation`
--
ALTER TABLE `playlistsongrelation`
  ADD KEY `playlistsongrelation_playlistid_foreign` (`playlistId`),
  ADD KEY `playlistsongrelation_songid_foreign` (`songId`);

--
-- Indexes for table `shareplaylist`
--
ALTER TABLE `shareplaylist`
  ADD KEY `shareplaylist_userid_foreign` (`userId`),
  ADD KEY `shareplaylist_playlistid_foreign` (`playlistId`);
...
ALTER TABLE `song`
  ...
  ADD KEY `song_albumid_foreign` (`albumId`);

--
-- Indexes for table `songartistrelation`
--
ALTER TABLE `songartistrelation`
  ADD KEY `songartistrelation_songid_foreign` (`songId`),
  ADD KEY `songartistrelation_artistid_foreign` (`artistId`);

--
-- Indexes for table `songcomment`
--
ALTER TABLE `songcomment`
  ADD PRIMARY KEY (`songCommentId`),
  ADD KEY `songcomment_userid_foreign` (`userId`),
  ADD KEY `songcomment_songid_foreign` (`songId`);

--
-- Indexes for table `songgenrerelation`
--
ALTER TABLE `songgenrerelation`
  ADD KEY `songgenrerelation_songid_foreign` (`songId`),
  ADD KEY `songgenrerelation_genreid_foreign` (`genreId`);
...
--
ALTER TABLE `artist`
  MODIFY `artistId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `genre`
--
ALTER TABLE `genre`
  MODIFY `genreId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `playlist`
  MODIFY `playlistId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `playlistcomment`
--
ALTER TABLE `playlistcomment`
  MODIFY `playlistCommentId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `song`
--
ALTER TABLE `song`
  MODIFY `songId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `songcomment`
--
ALTER TABLE `songcomment`
  MODIFY `songCommentId` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `listenhistory`
--
ALTER TABLE `listenhistory`
  ADD CONSTRAINT `listenhistory_songid_foreign` FOREIGN KEY (`songId`) REFERENCES `song` (`songId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `playlist`
--
ALTER TABLE `playlist`
  ADD CONSTRAINT `playlist_userid_foreign` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `playlistcomment`
--
ALTER TABLE `playlistcomment`
  ADD CONSTRAINT `playlistcomment_playlistid_foreign` FOREIGN KEY (`playlistId`) REFERENCES `playlist` (`playlistId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `playlistcomment_userid_foreign` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `playlistsongrelation`
--
ALTER TABLE `playlistsongrelation`
  ADD CONSTRAINT `playlistsongrelation_playlistid_foreign` FOREIGN KEY (`playlistId`) REFERENCES `playlist` (`playlistId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `playlistsongrelation_songid_foreign` FOREIGN KEY (`songId`) REFERENCES `song` (`songId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `shareplaylist`
--
ALTER TABLE `shareplaylist`
  ADD CONSTRAINT `shareplaylist_playlistid_foreign` FOREIGN KEY (`playlistId`) REFERENCES `playlist` (`playlistId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `shareplaylist_userid_foreign` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `song`
--
ALTER TABLE `song`
  ADD CONSTRAINT `song_albumid_foreign` FOREIGN KEY (`albumId`) REFERENCES `album` (`albumId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `songartistrelation`
--
ALTER TABLE `songartistrelation`
  ADD CONSTRAINT `songartistrelation_artistid_foreign` FOREIGN KEY (`artistId`) REFERENCES `artist` (`artistId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `songartistrelation_songid_foreign` FOREIGN KEY (`songId`) REFERENCES `song` (`songId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `songcomment`
--
ALTER TABLE `songcomment`
  ADD CONSTRAINT `songcomment_songid_foreign` FOREIGN KEY (`songId`) REFERENCES `song` (`songId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `songcomment_userid_foreign` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `songgenrerelation`
--
ALTER TABLE `songgenrerelation`
  ADD CONSTRAINT `songgenrerelation_genreid_foreign` FOREIGN KEY (`genreId`) REFERENCES `genre` (`genreId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `songgenrerelation_songid_foreign` FOREIGN KEY (`songId`) REFERENCES `song` (`songId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
